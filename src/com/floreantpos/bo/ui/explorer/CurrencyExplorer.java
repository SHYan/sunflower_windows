...
public class CurrencyExplorer extends TransparentPanel {
	...
	public CurrencyExplorer() {
		...
		tableModel.addColumn(Messages.getString("CURRENCY_CODE"), "code"); //$NON-NLS-1$
		tableModel.addColumn(Messages.getString("CURRENCY_SYMBOL"), "symbol"); //$NON-NLS-1$
		tableModel.addColumn(Messages.getString("CURRENCY_RATE"), "exchangeRate"); //$NON-NLS-1$
		tableModel.addColumn(Messages.getString("CURRENCY_MAIN"), "main"); //$NON-NLS-1$
		tableModel.addColumn(Messages.getString("CURRENCY_TOLERANCE"), "tolerance"); //$NON-NLS-1$
