...
public class QuickMaintenanceExplorer extends TransparentPanel {
	...
	public QuickMaintenanceExplorer() {
		...
		btnEdit = new POSToggleButton(Messages.getString("AttendanceHistoryExplorer.1"));
		btnCopy = new POSToggleButton(Messages.getString("COPY"));
		btnDelete = new POSToggleButton(Messages.getString("DEL"));
		...
		try {
			if (menuItem.getId() != null) {
				if (btnCopy.isSelected()) {
					...
					newMenuItem.setStockItem(menuItem.isStockItem());
