...
public class MultiplierExplorerAction extends AbstractAction {
	...
	public MultiplierExplorerAction() {
		super(Messages.getString("MULTIPLIERS"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(Messages.getString("MULTIPLIERS"));
		if (index == -1) {
			explorer = new MultiplierExplorer();
			tabbedPane.addTab(Messages.getString("MULTIPLIERS"), explorer);
		}
		else {
