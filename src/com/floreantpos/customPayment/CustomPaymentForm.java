...
public class CustomPaymentForm extends BeanEditor<CustomPayment> {
	...
	private void initComponent() {
		...
		txtRefNumberFieldName.setPreferredSize(new Dimension(120, 30));
	...
	public boolean save() {
		try {
			...
			ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(), 
					"Menu Manage", "Edit Custom Payment "+payment.getName());
			return true;
	...
	protected boolean updateModel() throws IllegalModelStateException {
		...
		payment.setName(txtName.getText().toUpperCase());
	...
	public boolean delete() {
		try {
			...
			ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(), 
					"Menu Manage", "Delete Custom Payment "+payment.getName());
			return true;
		} catch (Exception e) {
