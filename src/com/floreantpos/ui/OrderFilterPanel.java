	...
	private void createPaymentStatusFilterPanel() {
		...
		ActionListener psFilterHandler = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (actionCommand.equals("CLOSED") && !Application.getCurrentUser().hasPermission(UserPermission.VIEW_ALL_OPEN_TICKETS)) {
					...
					if (user2 == null) {
						...
						if (!user2.hasPermission(UserPermission.VIEW_ALL_OPEN_TICKETS)) {
