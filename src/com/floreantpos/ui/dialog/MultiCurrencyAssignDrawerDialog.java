...
public class MultiCurrencyAssignDrawerDialog extends OkCancelOptionDialog {
	...
	private void init() {
		...
		setTitle(Messages.getString("ENTER_DRAWER_AMOUNT"));
		setTitlePaneText(Messages.getString("ENTER_DRAWER_AMOUNT"));
		setResizable(false);
		...
		JLabel lblCurrency = getJLabel(Messages.getString("CurrencyExplorerAction.0"), Font.BOLD, 16, JLabel.CENTER);
		JLabel lblAmount = getJLabel(Messages.getString("PosMessage.38"), Font.BOLD, 16, JLabel.CENTER);
