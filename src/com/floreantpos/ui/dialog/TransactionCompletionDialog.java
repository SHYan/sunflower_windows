...
public class TransactionCompletionDialog extends POSDialog {
	...
	public void updateView() {
		lblTotalAmount.setText(NumberUtil.formatPrice(totalAmount));
		lblTenderedAmount.setText(NumberUtil.formatPrice(tenderedAmount));
		lblPaidAmount.setText(NumberUtil.formatPrice(paidAmount));
		lblDueAmount.setText(NumberUtil.formatPrice(dueAmount));
		lblGratuityAmount.setText(NumberUtil.formatPrice(gratuityAmount));
		lblFeeAmount.setText(NumberUtil.formatPrice(feeAmount));
		lblChangeDue.setText(NumberUtil.formatPrice(changeAmount));
	}
