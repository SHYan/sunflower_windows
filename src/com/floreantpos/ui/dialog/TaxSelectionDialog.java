...
public class TaxSelectionDialog extends POSDialog {
	...
	private void init() {
		...
		setTitle(Messages.getString("SELECT_TAX"));
		TitlePanel titelpanel = new TitlePanel();
		titelpanel.setTitle(Messages.getString("LABEL_TAX")+" : " + taxGroup.getName());
		...
		tableModel.addColumn(Messages.getString("PosMessage.64"), "rate"); //$NON-NLS-1$
	...
	private TransparentPanel createButtonPanel() {
		...
		JButton btnOk = new JButton(Messages.getString("TicketSelectionDialog.3"));
		...
		btnAdd.setText(Messages.getString("NEW_TAX"));
