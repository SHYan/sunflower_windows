...
public class SwitchboardOtherFunctionsDialog extends POSDialog implements ActionListener {
	...
	private PosButton btnPayout = new PosButton(POSConstants.PAYOUT_BUTTON_TEXT+"abc");
	...
	private void setupPermission() {
		...
		if (userType != null) {
			...
			if (permissions != null) {
				System.out.println(UserPermission.PAY_OUT +"" + (permissions.contains(UserPermission.PAY_OUT)));
				if(permissions.contains(UserPermission.PAY_OUT)) 
