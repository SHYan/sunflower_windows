		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedUser == null) {
					POSMessageDialog.showError(UserTransferDialog.this, Messages.getString("UserListDialog.4"));
					return;
				}
				if (!selectedUser.isClockedIn()) {
					POSMessageDialog.showError(UserTransferDialog.this, Messages.getString("USER_NOT_CLOCKIN"));
					return;
				}
