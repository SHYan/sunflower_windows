	...
	*/
	...
	public void transferTicketItem(TicketItem ticketItem, TicketForSplitView toTicketView) {
		...
		if(ticketItem.getIsReturn())
			POSMessageDialog.showError(Application.getPosWindow(), Messages.getString("CANNOT_SPLIT_RETURN_ITEM"));
		else
...
//		}
		...
		*/		
		ticketViewerTable.delete(ticketItem.getTableRowNum(), true); // J1.1 28
