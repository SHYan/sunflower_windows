...
public class MenuItemView extends SelectionView {
	...
	public void setMenuGroup(MenuGroup menuGroup) {
		...
		if(orderType==null) orderType = OrderView.getInstance().getCurrentTicket().getOrderType();
	...
	private void filterByStockAmount(MenuItem menuItem, ItemButton itemButton) {
		/* J1.1 52 change to stock item not disable when zero
		...
		private void updateView(MenuItem menuItem) {
			...
			if (menuItem.getImage() != null) {
				...
				if (menuItem.getId() == null) {
					...
					setText("<html><body><center>" + menuItem.getDisplayName()
							+ (!showPrice ? ""
									: "<br><h4>" + "<span style='color:white;background-color:green;margin:1;'>" + "&nbsp;" + "&nbsp;" + "&nbsp;"
											+ menuItem.getPriceByOrderType(orderType) + "&nbsp;" + "&nbsp;" + "&nbsp;" + "</span>")
							+ "&nbsp;"
							+ (!showStockCount ? ""
