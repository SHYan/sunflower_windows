...
public class SplitTicketDialog extends POSDialog {
	...
	private void createToolbarPanel() {
		...
		*/
		...
		btnSplitBySeat.setText(Messages.getString("SPLIT_BY_SEAT")); //$NON-NLS-1$
		...
		try {
			...
			*/
			...
			ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(), ActionHistory.SPLIT_CHECK,
					 "Seq:" + ticket.getId()+" / "+ticket2.getId()); //$NON-NLS-1$
	...
	public void saveTicket(TicketForSplitView view, Session session) {
		...
		/*J1.1 28*/
		if(splitTicket.getId()==null)
			splitTicket.setId(ticket.generateNewTicketId(null));
		splitTicket.setSplitId(ticket.getId());
		/*J1.1 30*/
		splitTicket.setOwnerName(Application.getCurrentUser().getFullName());
	...
	private void transferTicketTransactionToSplitTicket(Ticket originalTicket, Ticket splitTicket) {
		...
		try {
			for (Iterator iterator = transactions.iterator(); iterator.hasNext();) {
				...
				if (NumberUtil.roundToDigitPrice(posTransaction.getAmount()) == NumberUtil.roundToDigitPrice(splitTicket.getDueAmount())) {
