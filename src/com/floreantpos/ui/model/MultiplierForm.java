...
public class MultiplierForm extends BeanEditor {
	...
	private void initComponents() {
		...
		tfTicketPrefix.setPreferredSize(new Dimension(195, 30));
		tfRate.setPreferredSize(new Dimension(195, 30));
		tfSortOrder.setPreferredSize(new Dimension(195, 30));
		JPanel contentPanel = new JPanel(new MigLayout("fillx"));

		contentPanel.add(new javax.swing.JLabel(Messages.getString("PosMessage.179")));
		contentPanel.add(tfName, "grow,wrap");

		contentPanel.add(new javax.swing.JLabel(Messages.getString("TICKET_PREFIX")));
		contentPanel.add(tfTicketPrefix, "grow,wrap");

		contentPanel.add(new javax.swing.JLabel(Messages.getString("PosMessage.309")+" (%)"));
		contentPanel.add(tfRate, "grow,wrap");

		contentPanel.add(new javax.swing.JLabel(Messages.getString("SORT_ORDER")));
