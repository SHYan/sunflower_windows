...
public class ModifierPriceByOrderTypeDialog extends POSDialog {
	...
	private void createView() {
		...
		label1.setText(Messages.getString("ORDER_TYPE_BUTTON_TEXT")+" : "); //$NON-NLS-1$
		cbOrderTypes = new JComboBox();

		JLabel label3 = new JLabel();
		label3.setText(Messages.getString("TaxConfigurationView.0")+" : "); //$NON-NLS-1$
		cbTax = new JComboBox(new DefaultComboBoxModel(TaxDAO.getInstance().findAll().toArray()));

		JLabel lblExtraTax = new JLabel();
		lblExtraTax.setText(Messages.getString("EXTRA_TAX")+" : "); //$NON-NLS-1$
		...
		lblExtraPrice.setText(Messages.getString("EXTRA_PRICE"));
