...
public class ShiftEntryDialog extends POSDialog {
	...
	public ShiftEntryDialog(Shift shift) {
		...
		startHour.setPreferredSize(new Dimension(50, 30));
		endHour.setPreferredSize(new Dimension(50, 30));
		startMin.setPreferredSize(new Dimension(50, 30));
		endMin.setPreferredSize(new Dimension(50, 30));
		startAmPm.setPreferredSize(new Dimension(50, 30));
		endAmPm.setPreferredSize(new Dimension(50, 30));

		buttonOK.setPreferredSize(new Dimension(60, 40));
		buttonCancel.setPreferredSize(new Dimension(60, 40));
	...
	public void updateView() {
		...
		tfShiftName.setPreferredSize(new Dimension(120, 30));
	...
	private void $$$setupUI$$$() {
		...
		panel3.add(startHour, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
				GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(75, 30), null, 0, false));
		...
		panel3.add(endHour, new GridConstraints(5, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW,
				GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(75, 30), null, 0, false));
