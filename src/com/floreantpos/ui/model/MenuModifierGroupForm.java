...
public class MenuModifierGroupForm extends BeanEditor {
	...
	private void initComponents() {
		setLayout(new MigLayout("", "[45px][369px,grow]", "[30][]")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		jLabel1 = new javax.swing.JLabel();
		tfName = new FixedLengthTextField();
		//tfName.setLength(60);
		tfName.setPreferredSize(new Dimension(60,30));

		jLabel1.setText(com.floreantpos.POSConstants.NAME);

		add(jLabel1, "cell 0 0,alignx left,aligny center"); //$NON-NLS-1$
		add(tfName, "cell 1 0,growx,aligny center"); //$NON-NLS-1$
		...
		tfTranslatedName.setPreferredSize(new Dimension(60,30));
