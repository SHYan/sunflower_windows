...
public class MenuModifierForm extends BeanEditor {
	...
	private void initComponents() {
		...
		chkUseFixedPrice = new JCheckBox(Messages.getString("USE_FIXED_PRICE"));

		cbTaxes.setPreferredSize(new Dimension(90, 30));
		cbModifierGroup.setPreferredSize(new Dimension(195, 30));
		tfName.setPreferredSize(new Dimension(195, 30));
		tfTranslatedName.setPreferredSize(new Dimension(195, 30));
		tfSortOrder.setPreferredSize(new Dimension(195, 30));
		...
		JLabel lblPrice = new javax.swing.JLabel(Messages.getString("PosMessage.198") + ":");
	...
	private class MultiplierPricePanel extends JPanel {
		...
		public MultiplierPricePanel(Multiplier multiplier) {
			...
			tfAditionalPrice.setPreferredSize(new Dimension(100, 30));
			...
			if (multiplier.isMain()) {
				...
				btnCalculateMultilierPrice.setPreferredSize(new Dimension(40, 30));
