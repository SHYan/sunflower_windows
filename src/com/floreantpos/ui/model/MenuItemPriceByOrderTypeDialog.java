...
public class MenuItemPriceByOrderTypeDialog extends POSDialog {
	...
	private void createView() {
		...
		tfPrice.setPreferredSize(new Dimension(80, 30));
		JPanel panel = new JPanel(new MigLayout("", "grow", "")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		cbTax.setMinimumSize(new Dimension(80, 30));
		cbOrderTypes.setMinimumSize(new Dimension(80, 30));
		...
		btnCancel.setPreferredSize(new Dimension(60, 40));
