...
public class OrderTypeForm extends BeanEditor implements ItemListener {
	...
	private void initComponents() {
		...
		chkAllowSeatBasedOrder = new JCheckBox(Messages.getString("SEAT_BASE")); //$NON-NLS-1$
		...
		chkShowPriceOnButton = new JCheckBox(Messages.getString("PRICE_ON_BUTTON"));
		chkShowStockCountOnButton = new JCheckBox(Messages.getString("COUNT_ON_BUTTON"));
		chkShowUnitPriceInTicketGrid = new JCheckBox(Messages.getString("PRICE_ON_TICKET_GRID"));
		chkRetailOrder = new JCheckBox(Messages.getString("RETAIL"));
		chkAllowToAddTipsLater = new JCheckBox(Messages.getString("TIPS_LATER"));
