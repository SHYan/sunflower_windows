...
public class MenuItemModifierGroupForm extends BeanEditor {
	...
	private void initComponents() {
		...
		tfMinQuantity.setPreferredSize(new Dimension(180, 30));
		tfMaxQuantity.setPreferredSize(new Dimension(180, 30));
		cbModifierGroups.setPreferredSize(new Dimension(180, 30));
