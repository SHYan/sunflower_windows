...
public class TicketItemRowCreator {
	...
	public static void calculateTicketRows(Ticket ticket, Map<String, ITicketItem> tableRows, String calculateType) {
		if(calculateType == null)
			calculateTicketRows(ticket, tableRows, true, true, true, true);
		else if(calculateType.equals("summary"))
			calculateTicketRows(ticket, tableRows, true);
		else if(calculateType.equals("noDiscount"))
			calculateTicketRows(ticket, tableRows, true, true, true, false);
	}
