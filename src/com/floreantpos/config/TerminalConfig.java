...
public class TerminalConfig {
	...
	/*J1.1 35 not delete these three variables in order to used later*/
	...
	private static final String SET_SC = "set_sc";
	/* J1.1 36*/
	private static final String ONLYPAYINREPORT = "only_pay_in_report";

	/* J1.1 48*/
	private static final String OPEN_PRICE = "open_price";
	private static final String FRACTION_AUTO_OP = "fraction_auto_op";
	private static final String CUSTOM_QTY = "custom_qty";
	...
	private static final String SQL_FOLDER = "sql_folder";
	private static final String QTY_DECIMAL = "qty_decimal";
	private static final String PRICE_DECIMAL = "PRICE_decimal";
	...
	public static boolean isShouldShowGuestSelection() {
		return config.getBoolean(SHOW_GUEST_SELECTION, Boolean.FALSE);
	}
	...
	public static void setSC(boolean selected) {
		config.setProperty(SET_SC, selected);
	}
	
	public static boolean isSetSC() {
		return config.getBoolean(SET_SC, true);
	}
	
	public static void setCheck_stock(boolean check) {
		config.setProperty(CHECK_STOCK, check);
	}
	
	public static boolean isCheck_stock() {
		return config.getBoolean(CHECK_STOCK, false);
	}
	...
	/* J1.1 48 */
	public static void setOpenPrice(boolean selected) {
		config.setProperty(OPEN_PRICE, selected);
	}
	public static boolean isOpenPrice() {
		return config.getBoolean(OPEN_PRICE, false);
	}
	public static void setFractionAutoOP(boolean selected) {
		config.setProperty(FRACTION_AUTO_OP, selected);
	}
	
	public static boolean isFractionAutoOP() {
		return config.getBoolean(FRACTION_AUTO_OP, false);
	}
	/* J1.1 51 */
	...
	public static Boolean isCustomQty() {
		return config.getBoolean(CUSTOM_QTY, true);
	}
	
	public static void setCustomQty(boolean selected) {
		config.setProperty(CUSTOM_QTY, selected);
	}
	...
	public static String getLogo() {
		return config.getString(LOGO); //$NON-NLS-1$ //$NON-NLS-2$
	}

	public static void setLogo(String logoFile) {
		config.setProperty(LOGO, logoFile); //$NON-NLS-1$
	}
	
	public static String getExpTime() {
		return config.getString(EXP_TIME); //$NON-NLS-1$ //$NON-NLS-2$
	}

	public static void setExpTime(String exp) {
		config.setProperty(EXP_TIME, exp);//ON-NLS-1$
	}
	
	
	public static String getSqlFolder() {
		return config.getString(SQL_FOLDER); //$NON-NLS-1$ //$NON-NLS-2$
	}

	public static void setSqlFolder(String sqlFolder) {
		config.setProperty(SQL_FOLDER, sqlFolder); //$NON-NLS-1$
	}
	
	public static int getQtyDecimal() {
		return config.getInt(QTY_DECIMAL, 0);
	}

	public static void setQtyDecimal(int id) {
		if(id>4) id=4;
		if(id<0) id=0;
		config.setProperty(QTY_DECIMAL, id);
	}
	
	public static int getPriceDecimal() {
		return config.getInt(PRICE_DECIMAL, 0);
	}

	public static void setPriceDecimal(int id) {
		if(id>4) id=4;
		if(id<0) id=0;
		config.setProperty(PRICE_DECIMAL, id);
	}
