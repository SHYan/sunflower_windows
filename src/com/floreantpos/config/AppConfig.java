...
public class AppConfig {
	...
	static {
		try {
			...
			File configFile = new File("fuxunpos.config.properties"); //$NON-NLS-1$
			
			
			/**
			 * J1.1 4 if config.properties file is broken down, try to open backup file
			 */
			/*
	...
	public static String getDatabaseName() {
		return config.getString(DATABASE_NAME, "fuxunpos"); //$NON-NLS-1$
	}
	...
	public static String getDatabaseUser() {
		return config.getString(DATABASE_USER, "postgres"); //$NON-NLS-1$
	}
	...
	public static String getDatabasePassword() {
		return config.getString(DATABASE_PASSWORD, "FuXun!@#$%"); //$NON-NLS-1$
	}
	/*
