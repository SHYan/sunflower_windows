...
public class DatabaseConfigurationView extends ConfigurationView implements ActionListener {
	...
	protected void initUI() {
		...
		tfServerAddress.setPreferredSize(new Dimension(195, 30));
		tfServerPort.setPreferredSize(new Dimension(195, 30));
		tfDatabaseName.setPreferredSize(new Dimension(195, 30));
		tfUserName.setPreferredSize(new Dimension(195, 30));
		tfPassword.setPreferredSize(new Dimension(195, 30));
		databaseCombo.setPreferredSize(new Dimension(195, 30));
		...
		btnTestConnection.setPreferredSize(new Dimension(100, 30));
		btnSave.setPreferredSize(new Dimension(70, 30));
		btnCreateDb.setPreferredSize(new Dimension(140, 30));
		...
		try {
			...
			if (TEST.equalsIgnoreCase(command)) {
				...
				if (createDatabase) {
					...
					JOptionPane.showMessageDialog(POSUtil.getBackOfficeWindow(), Messages.getString("DB_CREATE_INFO")); //$NON-NLS-1$
