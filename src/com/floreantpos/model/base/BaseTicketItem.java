...
public abstract class BaseTicketItem  implements Comparable, Serializable {
	...
	public static String PROP_IS_RETURN = "isReturn"; //$NON-NLS-1$
	public static String PROP_RETURN_ITEM_ID = "returnItemId"; //$NON-NLS-1$
	...
	// fields
		...
		/* J1.1 19 */
		protected java.lang.Boolean isReturn;
	...
	public void setServiceChargeAmount(java.lang.Double serviceChargeAmount) {
		...
		this.serviceChargeAmount = (double) ((int) Math.round(serviceChargeAmount));
	}
	/* J1.1 20e */
