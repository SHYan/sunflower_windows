...
public abstract class BaseTicket  implements Comparable, Serializable {
	...
	//J1.1 28
	public static String PROP_SPLIT_ID = "splitId";
	...
	//J1.1 28
	protected java.lang.Integer splitId;
		
	/* J1.1 34 */
	protected Integer itemCount;
	protected Double itemQty;
	...
	public java.lang.Integer getId () {
		return id;
		/* J1.1 8*/
		//up row to column=id  *  generator-class="identity"

	}
	
	/**
	 * J1.1 8 
	 * generate new ticket id in yyMMdd### format mode, ### start from 001 for the first order of a new day and 
	 * increase from the second order
	 * @param ticketDAO can be NULL
	 * @return Integer ticket id
	 */
	public Integer generateNewTicketId(TicketDAO ticketDAO) {
		
		if(ticketDAO==null)
			ticketDAO = new TicketDAO();
		SimpleDateFormat dateFormat = new SimpleDateFormat("yyMMdd");
		String date = dateFormat.format(new Date());
		int newId = Integer.parseInt(date + "001");
		
		Integer maxId = ticketDAO.getMaxTicketId();
		if(maxId >= newId) {
			newId = maxId + 1; 
		}
		return newId;
	...
	public String getTableNames() {
		List<String> tmp = getTableNames(true); 
		return (tmp==null) ? "": tmp.toString();
	}
	
	public java.util.List<String> getTableNames(boolean all) {
	...
	/* J1.1 28*/ 
	public java.lang.Integer getSplitId () {
		return splitId == null ?  Integer.valueOf(0)  : splitId;
	}
	public void setSplitId (java.lang.Integer splitId) {
	...
	public java.lang.Double getItemQty () {
		return itemQty == null ?  Integer.valueOf(0)  : itemQty;
	}
