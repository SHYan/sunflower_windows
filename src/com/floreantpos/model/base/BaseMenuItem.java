...
public abstract class BaseMenuItem  implements Comparable, Serializable {
	...
	public static String PROP_STOCK_ITEM = "stockItem"; //$NON-NLS-1$
	...
	// fields
		...
		protected java.lang.Boolean stockItem;
	...
	public java.lang.Boolean isStockItem () {
									return stockItem == null ? Boolean.valueOf(false) : stockItem;
						}
	 ...
	 */
	public void setStockItem (java.lang.Boolean stockItem) {
