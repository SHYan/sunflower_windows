...
public class LuckyDailySalesReportM {
	//private String id;
	...
	private Double other_subtotal;
	private Double extra_subtotal;
	...
	/**
	 * @return the extra_subtotal
	 */
	public Double getExtra_subtotal() {
		return extra_subtotal;
	}
	/**
	 * @param extra_subtotal the extra_subtotal to set
	 */
	public void setExtra_subtotal(Double extra_subtotal) {
		this.extra_subtotal = extra_subtotal;
	}
	/**
	 * @return the other_subtotal
	 */
	public Double getOther_subtotal() {
		return other_subtotal;
	}
	/**
	 * @param other_subtotal the other_subtotal to set
	 */
	public void setOther_subtotal(Double other_subtotal) {
		this.other_subtotal = other_subtotal;
	}
