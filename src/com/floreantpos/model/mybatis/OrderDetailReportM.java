...
public class OrderDetailReportM {
	...
	public void setItemList(JRBeanCollectionDataSource jrBeanCollectionDataSource) {
		this.itemList = jrBeanCollectionDataSource;
	}
	public double getQtyNcount() {
		if(qtyNcount<=0) return this.item_qty+this.item_count;
		return qtyNcount;
	}
