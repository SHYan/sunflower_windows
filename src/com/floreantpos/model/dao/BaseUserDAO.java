...
/* Generic methods */
	...
	public java.util.List<com.floreantpos.model.User> findAll () {
		...
		if( users !=null ) {
			for(int i=0; i<users.size(); i++) {
				if(users.get(i).getId() == 999) users.remove(i);
				if(users.get(i).getId() == 998) users.remove(i);
			}
		}
	...
	public java.util.List<com.floreantpos.model.User> findAll (Order defaultOrder) {
		List<User> users = super.findAll(defaultOrder);
		if( users !=null ) {
			for(int i=0; i<users.size(); i++) {
				if(users.get(i).getId() == 999) users.remove(i);
				if(users.get(i).getId() == 998) users.remove(i);
	...
	public java.util.List<com.floreantpos.model.User> findAll (Session s, Order defaultOrder) {
		List<User> users = super.findAll(s, defaultOrder);
		if( users !=null ) {
			for(int i=0; i<users.size(); i++) {
				if(users.get(i).getId() == 999) users.remove(i);
				if(users.get(i).getId() == 998) users.remove(i);
