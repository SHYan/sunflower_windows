...
public class ServerProductivityReport {
	...
	public static class ServerProductivityReportTableModel extends ListTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			case 4:
				return NumberUtil.formatPrice(data.getTotalSales());

			case 5:
				return NumberUtil.formatPrice(data.getNetSales());
			
			case 6:
				return NumberUtil.formatPrice(data.getAverageNetSales());
			
			case 7:
				return NumberUtil.formatPrice(data.getTotalAllocation());
			
			case 8:
				return NumberUtil.formatPrice(data.getGrossSales());
			
			case 9:
				return NumberUtil.formatPrice(data.getSalesDiscount());
			
			case 10:
				return NumberUtil.formatPrice(data.getAverageCheck());
			
			case 11:
				return NumberUtil.formatPrice(data.getAverageGuest());
				
			case 12:
				return NumberUtil.formatPrice(data.getAllocation());
