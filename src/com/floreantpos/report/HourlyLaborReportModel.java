...
public class HourlyLaborReportModel extends ListTableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
			...
			case 3:
				return NumberUtil.formatPrice(reportData.getSales());
				
			case 4:
				return NumberUtil.formatPrice(reportData.getManHour());
				
			case 5:
				return NumberUtil.formatPrice(reportData.getLabor());
				
			case 6:
				return NumberUtil.formatPrice(reportData.getSalesPerMHr());
				
			case 7:
				return NumberUtil.formatPrice(reportData.getGuestsPerMHr());
				
			case 8:
				return NumberUtil.formatPrice(reportData.getCheckPerMHr());
				
			case 9:
				return NumberUtil.formatPrice(reportData.getLaborCost());
		}
		return null; 
	}
}
