...
public class OrderPaymentReportView extends JPanel {
	...
	private JLabel lblPaymentName = new JLabel("TYPE / REF : ");
	
	private JButton btnGo = new JButton(com.floreantpos.POSConstants.GO);
	private JPanel reportContainer;
	private JComboBox cbPrintType;
	
	public OrderPaymentReportView() {
		...
		tfPaymentName.setPreferredSize(new Dimension(130, 30));
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(), 
							"Report Query", "Order Payment Report");
				} catch (Exception e1) {
					POSMessageDialog.showError(OrderPaymentReportView.this, POSConstants.ERROR_MESSAGE, e1);
				}
			}
	...
	private void viewReport() throws Exception {
		...
		List<PaymentReportM> dataSource = IBatisFactory.selectList("Report.getOrder_Sales_Payment", map);
		
		String reportTemplate = "order_payment_report";
		if(cbPrintType.getSelectedItem().toString().equals("80mm"))
			reportTemplate = "order_payment_report_80mm";
