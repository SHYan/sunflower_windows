...
public class ReportUtil {
	...
	public static void populateRestaurantProperties(Map map) {
		...
		if(TerminalConfig.getUiDefaultFont()!=null && TerminalConfig.getUiDefaultFont().equals("Zawgyi-One")) {
	...
	public static JasperReport getReport(String reportName) {
		...
		try {
			...
			//POSMessageDialog.showError(Application.getPosWindow(), reportName+e.getMessage());
	...
	private static JasperReport getDefaultReport(String reportName) {
		...
		try {
			...
			//POSMessageDialog.showError(Application.getPosWindow(), "2"+reportName+e.getMessage());
